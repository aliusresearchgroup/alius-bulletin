...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \fill[white] (68.140bp,-217.528bp) rectangle ++(276.680bp,-88.900bp);
  \node[anchor=north west,inner sep=0pt,outer sep=0pt,text=ALIUSC000000] at (69.640bp,-219.528bp) {\begin{minipage}{273.680bp}{\ALIUSFontLatoLight\fontsize{9.200bp}{10.700bp}\selectfont\raggedright Cite as: Ratcliffe, M. \& Frerejouan, M. (2018). Verbal hallucinations, intentionality, and interpersonal experience. An interview with Matthew Ratcliffe. ALIUS Bulletin, 2, 95-107.\par}\end{minipage}};
  \node[anchor=south east,inner sep=0pt,outer sep=0pt,text=ALIUSC1F8135] at (343.320bp,-301.928bp) {{\ALIUSFontLatoLight\fontsize{8.600bp}{8.600bp}\selectfont\href{https://doi.org/10.34700/913r-wa92}{https://doi.org/10.34700/913r-wa92}}};
