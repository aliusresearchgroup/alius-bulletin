...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{354.760}{183.755}{133.673}{ALIUSC000000}{\ALIUSFontLatoLight}{8.880}{UniversitÃ© Paris Descartes, France}
  ...
  \ALIUSPlacedTextContent{71.080}{341.488}{455.842}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.960}{consciousness (O'Regan \& NoÃ« 2001, NoÃ« \& O'Regan 2002; Myin \& O'Regan 2002,}
  ...
  \ALIUSPlacedTextContent{71.080}{388.288}{455.804}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.960}{sensorimotor contingencies of the animal in relation with the environmentâ€”both}
  ...
  \ALIUSPlacedTextContent{71.080}{635.898}{456.660}{ALIUSC1A1718}{\ALIUSFontCormorantRegular}{13.920}{mysteryâ€”they think that there is a problem in explaining how physical and chemical}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{71.080}{35.460}{165.820}{ALIUSC767171}{\ALIUSFontLatoLight}{10.800}{K. O'Regan â€“ On the "feel" of things}
  ...
  \ALIUSPlacedTextContent{71.080}{349.338}{456.558}{ALIUSC1A1718}{\ALIUSFontCormorantRegular}{13.920}{developed cognitive capacities, including the ability to conceive of one's "self"â€”but}
  ...
  \ALIUSPlacedTextContent{140.440}{565.913}{14.160}{ALIUSC7F7F7F}{\ALIUSFontCormorantLight}{48.000}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{162.049}{565.913}{281.508}{ALIUSC595959}{\ALIUSFontLatoLight}{14.880}{We should conceive of the feel of a pain, and}
  \ALIUSPlacedTextContent{158.440}{583.673}{288.726}{ALIUSC595959}{\ALIUSFontLatoLight}{14.880}{the feel of red, and all perceptual experiences}
  \ALIUSPlacedTextContent{451.166}{601.433}{14.160}{ALIUSC7F7F7F}{\ALIUSFontCormorantLight}{48.000}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{294.524}{601.433}{16.558}{ALIUSC595959}{\ALIUSFontLatoLight}{14.880}{as}
  \ALIUSPlacedTextContent{203.022}{601.433}{199.563}{ALIUSC595959}{\ALIUSFontLatoLightItalic}{14.880}{ways of interacting with the world}
  \ALIUSPlacedTextContent{299.807}{601.433}{5.992}{ALIUSC595959}{\ALIUSFontLatoLight}{14.880}{.}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{71.080}{553.168}{455.845}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.960}{et al. 1988; \ALIUSCitationLink{aliusref-oregan-erickson-davis-ballard-hayhoe-1997}{Ballard et al. 1997}), embodied artificial intelligence (Brooks 1991),}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{80.680}{324.233}{14.160}{ALIUSC7F7F7F}{\ALIUSFontCormorantLight}{48.000}{\ALIUSPullQuoteOpen}
  ...
  \ALIUSPlacedTextContent{109.605}{341.993}{387.839}{ALIUSC595959}{\ALIUSFontLatoLight}{14.880}{realized that if we understand the what-it's-like of perceptual}
  \ALIUSPlacedTextContent{98.863}{359.753}{409.322}{ALIUSC595959}{\ALIUSFontLatoLight}{14.880}{experience as being constituted by what we do when we interact}
  \ALIUSPlacedTextContent{512.368}{377.513}{14.160}{ALIUSC7F7F7F}{\ALIUSFontCormorantLight}{48.000}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{148.728}{377.513}{309.592}{ALIUSC595959}{\ALIUSFontLatoLight}{14.880}{with the world, then there is actually no mystery.}
  ...
  \ALIUSPlacedTextContent{71.080}{490.768}{455.749}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.960}{of sensorimotor contingencies" (O'Regan \& NoÃ« 2001, p. 962). What kinds of}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{71.080}{102.208}{455.737}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.960}{structure") (O'Regan \& NoÃ« 2001, p. 956). That is to say: sensory substitution. Can}
  ...
  \ALIUSPlacedTextContent{134.440}{499.193}{14.160}{ALIUSC7F7F7F}{\ALIUSFontCormorantLight}{48.000}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{160.984}{499.193}{291.073}{ALIUSC595959}{\ALIUSFontLatoLight}{14.880}{We will have machines that interact with us in}
  \ALIUSPlacedTextContent{162.255}{517.193}{288.531}{ALIUSC595959}{\ALIUSFontLatoLight}{14.880}{ways that gradually involve higher and higher}
  ...
  \ALIUSPlacedTextContent{156.885}{553.193}{299.272}{ALIUSC595959}{\ALIUSFontLatoLight}{14.880}{will not hesitate to say that they are conscious.}
  \ALIUSPlacedTextContent{464.602}{553.193}{14.160}{ALIUSC7F7F7F}{\ALIUSFontCormorantLight}{48.000}{\ALIUSPullQuoteClose}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{71.080}{439.408}{453.275}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.960}{How can sensorimotor theory be applied to "alternative" states if consciousnessâ€”}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{71.080}{101.585}{340.123}{ALIUSC1A1718}{\ALIUSFontCormorantRegular}{12.960}{\ALIUSRefAnchor{aliusref-oregan-erickson-davis-aloimonos-weiss-1988}Aloimonos, J., Weiss, I., Bandyopadhyay, A. (1988). Active vision.}
  ...
  \ALIUSPlacedTextContent{71.080}{145.025}{456.376}{ALIUSC222222}{\ALIUSFontCormorantRegular}{12.960}{\ALIUSRefAnchor{aliusref-oregan-erickson-davis-ballard-hayhoe-1997}Ballard, D. H., Hayhoe, M. M., Pook, P. K., \& Rao, R. P. (1997). Deictic codes for the}
  ...
  \ALIUSPlacedTextContent{71.080}{188.465}{399.961}{ALIUSC222222}{\ALIUSFontCormorantRegular}{12.960}{\ALIUSRefAnchor{aliusref-oregan-erickson-davis-braund-2008}Braund, M. J. (2008). The structures of perception: An ecological perspective.}
  ...
  \ALIUSPlacedTextContent{71.080}{231.905}{291.699}{ALIUSC222222}{\ALIUSFontCormorantRegular}{12.960}{\ALIUSRefAnchor{aliusref-oregan-erickson-davis-brooks-1991}Brooks, R. A. (1991). Intelligence without representation.}
  ...
  \ALIUSPlacedTextContent{71.080}{275.345}{323.423}{ALIUSC222222}{\ALIUSFontCormorantRegular}{12.960}{\ALIUSRefAnchor{aliusref-oregan-erickson-davis-gibson-1966}Gibson, J. J. (1966). The senses considered as perceptual systems.}
  \ALIUSPlacedTextContent{71.080}{303.185}{95.655}{ALIUSC222222}{\ALIUSFontCormorantRegular}{12.960}{\ALIUSRefAnchor{aliusref-oregan-erickson-davis-gibson-2014}Gibson, J. J. (2014).}
  ...
  \ALIUSPlacedTextContent{71.080}{331.025}{456.401}{ALIUSC222222}{\ALIUSFontCormorantRegular}{12.960}{\ALIUSRefAnchor{aliusref-oregan-erickson-davis-o-regan-noe-2001}O'Regan, J. K., \& NoÃ«, A. (2001). A sensorimotor account of vision and visual}
  ...
  \ALIUSPlacedTextContent{71.080}{374.465}{456.340}{ALIUSC222222}{\ALIUSFontCormorantRegular}{12.960}{\ALIUSRefAnchor{aliusref-oregan-erickson-davis-myin-o-regan-2002}Myin, E., \& O'Regan, J. K. (2002). Perceptual consciousness, access to modality and skill}
  ...
  \ALIUSPlacedTextContent{71.080}{433.745}{456.318}{ALIUSC222222}{\ALIUSFontCormorantRegular}{12.960}{\ALIUSRefAnchor{aliusref-oregan-erickson-davis-noe-o-regan-2002}NoÃ«, A., \& O'Regan, J. K. (2002). On the brain-basis of visual consciousness: A sensorimotor}
  ...
  \ALIUSPlacedTextContent{71.080}{477.185}{108.918}{ALIUSC222222}{\ALIUSFontCormorantRegular}{12.960}{\ALIUSRefAnchor{aliusref-oregan-erickson-davis-o-regan-2011}O'Regan, J. K. (2011).}
  ...
  \ALIUSPlacedTextContent{71.080}{520.625}{456.310}{ALIUSC222222}{\ALIUSFontCormorantRegular}{12.960}{\ALIUSRefAnchor{aliusref-oregan-erickson-davis-o-regan-2014}O'Regan, J. K. (2014). The explanatory status of the sensorimotor approach to phenomenal}
  ...
  \ALIUSPlacedTextContent{71.080}{564.065}{456.296}{ALIUSC222222}{\ALIUSFontCormorantRegular}{12.960}{\ALIUSRefAnchor{aliusref-oregan-erickson-davis-thompson-varela-2001}Thompson, E., \& Varela, F. J. (2001). Radical embodiment: neural dynamics and}
  ...
  \ALIUSPlacedTextContent{71.080}{607.505}{206.082}{ALIUSC222222}{\ALIUSFontCormorantRegular}{12.960}{\ALIUSRefAnchor{aliusref-oregan-erickson-davis-varela-bourgine-1992}Varela, F. J., \& Bourgine, P. (Eds.). (1992).}
  ...
  \ALIUSPlacedTextContent{71.080}{651.185}{249.058}{ALIUSC222222}{\ALIUSFontCormorantRegular}{12.960}{\ALIUSRefAnchor{aliusref-oregan-erickson-davis-varela-thompson-2017}Varela, F. J., Thompson, E., \& Rosch, E. (2017).}
