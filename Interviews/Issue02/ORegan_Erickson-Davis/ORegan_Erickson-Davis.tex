...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \node[anchor=north west,inner sep=0pt,outer sep=0pt,text=ALIUSC1F8135] at (69.640bp,-267.408bp) {{\ALIUSFontLatoLight\fontsize{8.600bp}{8.600bp}\selectfont\href{https://doi.org/10.34700/zam3-yk89}{https://doi.org/10.34700/zam3-yk89}}};
