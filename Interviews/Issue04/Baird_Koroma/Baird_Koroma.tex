...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \fill[white] (87.291bp,-271.242bp) rectangle ++(305.240bp,-88.670bp);
  \node[anchor=north west,inner sep=0pt,outer sep=0pt,text=ALIUSC000000] at (88.791bp,-273.242bp) {\begin{minipage}{302.240bp}{\ALIUSFontLatoLight\fontsize{9.200bp}{10.700bp}\selectfont\raggedright Cite as: Baird, B. \& Koroma, M. (2020). Internally generated conscious activity: Reflections upon (lucid) dreaming, mind-wandering and meditation. An interview with Benjamin Baird by Matthieu Koroma. ALIUS Bulletin, 4, 24-38,\par}\end{minipage}};
  \node[anchor=south east,inner sep=0pt,outer sep=0pt,text=ALIUSC1F8135] at (391.031bp,-355.412bp) {{\ALIUSFontLatoLight\fontsize{8.600bp}{8.600bp}\selectfont\href{https://doi.org/10.34700/h9bs-xs28}{https://doi.org/10.34700/h9bs-xs28}}};
