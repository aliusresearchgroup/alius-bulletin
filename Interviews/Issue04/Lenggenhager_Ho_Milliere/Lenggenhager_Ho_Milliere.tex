...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \fill[white] (94.731bp,-258.282bp) rectangle ++(248.360bp,-95.500bp);
  \node[anchor=north west,inner sep=0pt,outer sep=0pt,text=ALIUSC000000] at (96.231bp,-260.282bp) {\begin{minipage}{245.360bp}{\ALIUSFontLatoLight\fontsize{9.200bp}{10.700bp}\selectfont\raggedright Cite as: Lenggenhager, B., Ho, J. T. \& Millière, R. (2020). Bodily boundaries and beyond: Exploring the malleability of bodily self-consciousness. An interview with Bigna Lenggenhager by Jasmine T. Ho and Raphaël Millière. ALIUS Bulletin, 4, 82-105,\par}\end{minipage}};
  \node[anchor=north west,inner sep=0pt,outer sep=0pt,text=ALIUSC1F8135] at (96.231bp,-318.282bp) {{\ALIUSFontLatoLight\fontsize{8.600bp}{8.600bp}\selectfont\href{https://doi.org/10.34700/2vez-qq65}{https://doi.org/10.34700/2vez-qq65}}};
