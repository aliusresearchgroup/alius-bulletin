...
\ifdefined\ALIUSIssueBuild
  \IfFileExists{\ALIUSRootPrefix Shared-assets/original-pdfs/Issue06/alius-bulletin-issue-06-ciaunica-what-is-like-to-be-in-early-sensory-life.pdf}{%
    \includepdf[pages=-,fitpaper=true]{\ALIUSRootPrefix Shared-assets/original-pdfs/Issue06/alius-bulletin-issue-06-ciaunica-what-is-like-to-be-in-early-sensory-life.pdf}%
  }{%
    \typeout{ALIUS warning: missing source PDF Shared-assets/original-pdfs/Issue06/alius-bulletin-issue-06-ciaunica-what-is-like-to-be-in-early-sensory-life.pdf}%
  }%
