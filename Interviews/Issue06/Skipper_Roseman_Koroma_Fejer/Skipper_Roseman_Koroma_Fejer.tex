...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  % ALIUS normalized citation panel text: Cite as: Skipper, J., Fejer, G., Koroma, M., Roseman, L., (2024). The intimacy of psychedelics, language, and consciousness. An interview with Jeremy Skipper by Leor Roseman, ALIUS Bulletin, 6,
  \fill[white] (75.525bp,-298.230bp) rectangle ++(315.000bp,-51.300bp);
  \node[anchor=north west,inner sep=0pt,outer sep=0pt,text=ALIUSC000000] at (77.025bp,-300.230bp) {\begin{minipage}{312.000bp}{\ALIUSFontLatoLight\fontsize{9.200bp}{10.700bp}\selectfont\raggedright Cite as: Skipper, J., Fejer, G., Koroma, M., Roseman, L., (2024). The intimacy of psychedelics, language, and consciousness. An interview with Jeremy Skipper by Leor Roseman, ALIUS Bulletin, 6, \mbox{\textcolor{ALIUSC1F8135}{\href{https://doi.org/10.5281/zenodo.11091861}{https://doi.org/10.5281/zenodo.11091861}}}\par}\end{minipage}};
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{155.502}{286.295}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{173.502}{286.295}{247.995}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{I’ve tried to adapt to my weirdness by}
  \ALIUSPlacedTextContent{425.498}{307.045}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{201.020}{307.045}{192.960}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{becoming weirder sometimes.}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{54.245}{89.200}{14.160}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.000}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{72.245}{89.200}{450.510}{ALIUSC000000}{\ALIUSFontLatoLight}{15.025}{I’ve always taken a little bit more tricky approach to the neurobiology}
  \ALIUSPlacedTextContent{102.920}{109.700}{389.160}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{of language. We are using it right now, it is a conversational}
  \ALIUSPlacedTextContent{526.755}{130.200}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{115.452}{130.200}{364.095}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{perspective, where we actually make use of the context.}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{106.059}{100.700}{14.160}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.000}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{124.059}{100.700}{346.882}{ALIUSC000000}{\ALIUSFontLatoLight}{15.025}{A really interesting way of thinking about speech and}
  \ALIUSPlacedTextContent{177.043}{121.245}{240.915}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{language is that it is a grand delusion.}
  \ALIUSPlacedTextContent{474.941}{121.245}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteClose}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{70.912}{117.745}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{100.010}{117.745}{394.980}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{There is currently more and more use of the term: “language}
  \ALIUSPlacedTextContent{88.912}{138.245}{417.175}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{network”. This concept bothers me because I do not think there}
  \ALIUSPlacedTextContent{510.087}{158.745}{14.160}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.000}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{200.270}{158.745}{194.460}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{are stable regions in the brain.}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{62.847}{215.525}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{84.360}{215.525}{426.280}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{It would be a mistake to call those regions the “language network”}
  \ALIUSPlacedTextContent{90.658}{236.025}{413.685}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{and assume that that is where language is processed only. Such}
  \ALIUSPlacedTextContent{80.847}{256.525}{433.306}{ALIUSC000000}{\ALIUSFontLatoLight}{15.025}{claims in the literature, that we teach our students and that can be}
  \ALIUSPlacedTextContent{197.270}{277.025}{200.460}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{found in textbooks, are absurd.}
  \ALIUSPlacedTextContent{518.153}{277.025}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteClose}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{53.382}{172.859}{14.160}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.000}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{83.101}{172.859}{428.798}{ALIUSC000000}{\ALIUSFontLatoLight}{15.025}{We study language with fMRI, leading to the illusion that we have}
  \ALIUSPlacedTextContent{81.958}{193.359}{431.085}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{this specific set of regions that process language. But if we [could]}
  \ALIUSPlacedTextContent{71.382}{213.859}{452.235}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{study every neuron in every neuromodulatory system at once, I think}
  \ALIUSPlacedTextContent{527.618}{234.359}{14.160}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.000}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{88.000}{234.359}{419.000}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{we would learn that there are no language networks in the brain.}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{67.092}{644.870}{14.160}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.000}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{85.092}{644.870}{424.817}{ALIUSC000000}{\ALIUSFontLatoLight}{15.025}{The idea that language is in the left hemisphere is antiquated and}
  \ALIUSPlacedTextContent{109.535}{665.665}{375.930}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{wrong and really depends on what you mean by language.}
  \ALIUSPlacedTextContent{513.909}{665.665}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{72.025}{741.086}{112.024}{ALIUSC767171}{\ALIUSFontCormorantRegular}{11.000}{ALIUS Bulletin n°6 (2024)}
  \ALIUSPlacedTextContent{406.170}{741.086}{108.317}{ALIUSC1155CC}{\ALIUSFontCormorantRegular}{11.000}{aliusresearch.org/bulletin}
\end{tikzpicture}
\null
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{72.025}{169.614}{471.111}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{related regions (\ALIUSCitationLink{aliusref-skipper-roseman-koroma-fejer-pinto-neville-2017}{Pinto et al., 2017}). I review a whole ton of evidence points toward a}
  \ALIUSPlacedTextContent{72.025}{189.144}{471.401}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{strong connection between language and consciousness (\ALIUSCitationLink{aliusref-skipper-roseman-koroma-fejer-skipper-2022}{Skipper, 2022}), which may}
  ...
  \ALIUSPlacedTextContent{61.022}{253.750}{14.160}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.000}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{79.022}{253.750}{436.957}{ALIUSC000000}{\ALIUSFontLatoLight}{15.025}{I would like to test some of my own theories by injecting DMT into}
  \ALIUSPlacedTextContent{107.780}{274.250}{379.440}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{the right hemisphere and maintain an observing conscious}
  \ALIUSPlacedTextContent{85.303}{294.750}{424.395}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{language, a self, to actually describe some of the things that have}
  \ALIUSPlacedTextContent{519.979}{315.250}{14.160}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.000}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{198.597}{315.250}{197.805}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{been typically called ineffable.}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{66.673}{88.804}{14.160}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.000}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{90.088}{88.804}{414.825}{ALIUSC000000}{\ALIUSFontLatoLight}{15.025}{Language organizes our thoughts perceptually, emotionally, and}
  \ALIUSPlacedTextContent{141.762}{109.304}{311.475}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{abstractly, and is a tool for organizing the world.}
  \ALIUSPlacedTextContent{287.652}{109.304}{19.695}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{[…]}
  \ALIUSPlacedTextContent{84.673}{129.804}{425.655}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{Language is not separable from consciousness and generates and}
  \ALIUSPlacedTextContent{514.327}{150.304}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{143.775}{150.304}{307.450}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{maintains conscious experience in and of itself.}
  ...
  \ALIUSPlacedTextContent{72.025}{634.264}{471.333}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{world even without using these words (\ALIUSCitationLink{aliusref-skipper-roseman-koroma-fejer-cook-kay-2005}{Cook et al., 2005}). The low-level core process}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{49.940}{215.525}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{67.940}{215.525}{459.120}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{Aphasic people also experience an increased connection to everything}
  \ALIUSPlacedTextContent{70.550}{236.025}{453.900}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{[…]. This is quite similar to the maybe more intense phenomenological}
  \ALIUSPlacedTextContent{531.060}{256.525}{14.160}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.000}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{127.327}{256.525}{340.346}{ALIUSC000000}{\ALIUSFontLatoLight}{15.025}{aspects of psychedelics, and meditative experiences}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{72.025}{614.764}{470.736}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{say this in my paper (\ALIUSCitationLink{aliusref-skipper-roseman-koroma-fejer-skipper-2022}{Skipper, 2022}). So I can say that in an interview and be trashed}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{75.326}{95.450}{14.160}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.000}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{93.326}{95.450}{408.349}{ALIUSC000000}{\ALIUSFontLatoLight}{15.025}{At a fundamental level, I have to accept that language is causal}
  \ALIUSPlacedTextContent{95.548}{115.950}{403.905}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{determinant of consciousness. […] I think people are confused}
  \ALIUSPlacedTextContent{505.674}{136.450}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{99.178}{136.450}{396.645}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{about what causality is, particularly in cognitive neuroscience.}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{86.893}{92.450}{14.160}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.000}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{116.681}{92.450}{361.637}{ALIUSC000000}{\ALIUSFontLatoLight}{15.025}{Going back to my own research on the neurobiology of}
  \ALIUSPlacedTextContent{104.893}{112.950}{385.215}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{language, I believe that words are deeply tied to every inch}
  \ALIUSPlacedTextContent{187.377}{133.450}{220.245}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{and every centimeter of the brain.}
  \ALIUSPlacedTextContent{494.107}{133.450}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteClose}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{57.322}{90.450}{14.160}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.000}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{75.322}{90.450}{444.356}{ALIUSC000000}{\ALIUSFontLatoLight}{15.025}{Speech is on a continuum more or less far away from consciousness}
  \ALIUSPlacedTextContent{523.678}{111.245}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{106.445}{111.245}{382.110}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{depending on being less likely to engage the motor system.}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{64.147}{90.950}{14.160}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.000}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{90.335}{90.950}{414.329}{ALIUSC000000}{\ALIUSFontLatoLight}{15.025}{There’s still some debate and skepticism about whether there is}
  \ALIUSPlacedTextContent{82.355}{111.495}{430.290}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{any narrative self at all, and Strawson, I believe, claims that he has}
  \ALIUSPlacedTextContent{516.852}{132.040}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{82.147}{132.040}{430.705}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{no narrative self but just episodic memories, and that’s fine for me.}
  ...
  \ALIUSPlacedTextContent{72.025}{317.164}{471.265}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{My model is the HOLISTIC model (\ALIUSCitationLink{aliusref-skipper-roseman-koroma-fejer-skipper-2022}{Skipper, 2022}). I really wanted to move my career}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{91.423}{400.065}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{109.423}{400.065}{376.155}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{I think nobody thinks about the self as a unitary construct}
  \ALIUSPlacedTextContent{489.577}{420.845}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{163.438}{420.845}{268.125}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{anymore: there are different kinds of self.}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{72.025}{362.684}{470.818}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{procedures mapping out the epicenters of epilepsy (\ALIUSCitationLink{aliusref-skipper-roseman-koroma-fejer-penfield-jasper-1954}{Penfield \& Jasper, 1954}). When he}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{79.955}{197.025}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{98.803}{197.025}{397.395}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{One hypothesis could be [that] vision steals the show. At the}
  \ALIUSPlacedTextContent{111.920}{217.525}{371.160}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{start of a DMT trip, everything in the visual experience is}
  \ALIUSPlacedTextContent{501.045}{238.025}{14.160}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.000}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{97.955}{238.025}{399.090}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{geometric and crazy and there’s almost no room for language.}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{72.025}{634.264}{471.073}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{predict changes in mental health and well-being (\ALIUSCitationLink{aliusref-skipper-roseman-koroma-fejer-gregoire-doucerain-2021}{Grégoire et al., 2021}; Nezlek et al.,}
  \ALIUSPlacedTextContent{72.025}{653.764}{470.778}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{2017; \ALIUSCitationLink{aliusref-skipper-roseman-koroma-fejer-tov-ng-2013}{Tov et al., 2013}). Who is going to benefit from therapy can be predicted from}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{72.025}{473.056}{470.592}{ALIUSC1F8135}{\ALIUSFontLatoRegular}{12.000}{religious and psychedelic experiences (\ALIUSCitationLink{aliusref-skipper-roseman-koroma-fejer-fortier-canna-2018}{Fortier \& Canna, 2018}). According to her}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{72.025}{72.094}{471.002}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{Nick \ALIUSCitationLink{aliusref-skipper-roseman-koroma-fejer-chater-2018}{Chater (2018)} has a quite controversial hypothesis called the mind is flat. Its basic}
  ...
  \ALIUSPlacedTextContent{78.373}{209.525}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{111.238}{209.525}{372.525}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{In my view, even during intense psychedelic experiences,}
  \ALIUSPlacedTextContent{96.373}{230.025}{402.255}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{such as those induced by high doses of DMT, where one may}
  \ALIUSPlacedTextContent{108.192}{250.525}{378.615}{ALIUSC000000}{\ALIUSFontLatoLight}{15.025}{feel detached from reality, the language system still subtly}
  \ALIUSPlacedTextContent{502.628}{271.025}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{225.092}{271.025}{144.815}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{guides the experience.}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{81.673}{159.245}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{103.208}{159.245}{388.585}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{I have given up on the first-person subjective experience to}
  \ALIUSPlacedTextContent{99.673}{179.800}{395.653}{ALIUSC000000}{\ALIUSFontLatoLight}{15.025}{be a scientist and don’t have much faith that we may be able}
  \ALIUSPlacedTextContent{499.327}{200.355}{14.167}{ALIUSC595959}{\ALIUSFontCormorantRegular}{48.025}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{133.600}{200.355}{327.800}{ALIUSC000000}{\ALIUSFontLatoLight}{15.000}{to describe that first-person subjective experience.}
  ...
  \ALIUSPlacedTextContent{72.025}{647.514}{100.940}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-chater-2018}Chater, N. (2018).}
  ...
  \ALIUSPlacedTextContent{72.025}{681.539}{471.439}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-cook-kay-2005}Cook, R. S., Kay, P., \& Regier, T. (2005). The World Color Survey Database. In}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{72.025}{72.094}{471.016}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-chalmers-1997}Chalmers, D. J. (1997). The conscious mind: In search of a fundamental theory. Oxford}
  \ALIUSPlacedTextContent{108.050}{89.094}{67.806}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{Paperbacks.}
  \ALIUSPlacedTextContent{72.025}{105.864}{471.073}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-decasper-spence-1986}DeCasper, A. J., \& Spence, M. J. (1986). Prenatal maternal speech influences newborns’}
  ...
  \ALIUSPlacedTextContent{72.025}{156.864}{427.701}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-dennett-1993}Dennett, D. C., \& Dennett, D. C. (1993). Consciousness explained. Penguin uk.}
  \ALIUSPlacedTextContent{72.025}{173.864}{470.820}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-fortier-canna-2018}Fortier, M., \& Canna, M. (2018). Conceptual, anthropological and cognitive issues}
  ...
  \ALIUSPlacedTextContent{72.025}{224.644}{287.028}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-gazzaniga-1998}Gazzaniga, M. S. (1998). The split brain revisited.}
  ...
  \ALIUSPlacedTextContent{72.025}{258.634}{471.229}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-gregoire-doucerain-2021}Grégoire, S., Doucerain, M., Morin, L., \& Finkelstein-Fox, L. (2021). The relationship}
  ...
  \ALIUSPlacedTextContent{72.025}{326.414}{122.430}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-hurlburt-2011}Hurlburt, R. T. (2011).}
  ...
  \ALIUSPlacedTextContent{72.025}{360.434}{471.059}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-nezlek-newman-2017}Nezlek, J. B., Newman, D. B., \& Thrash, T. M. (2017). A daily diary study of relationships}
  ...
  \ALIUSPlacedTextContent{72.025}{411.184}{470.862}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-penfield-jasper-1954}Penfield, W., \& Jasper, H. (1954). Epilepsy and the functional anatomy of the human}
  \ALIUSPlacedTextContent{108.050}{428.214}{38.526}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{brain.}
  \ALIUSPlacedTextContent{72.025}{445.214}{471.072}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-penfield-perot-1963}Penfield, W., \& Perot, P. (1963). The brain’s record of auditory and visual experience: a}
  ...
  \ALIUSPlacedTextContent{72.025}{495.964}{470.722}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-pinto-neville-2017}Pinto, Y., Neville, D. A., Otten, M., Corballis, P. M., Lamme, V. A. F., de Haan, E. H.}
  ...
  \ALIUSPlacedTextContent{72.025}{546.984}{470.722}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-skipper-2022}Skipper, J. I. (2022). A voice without a mouth no more: The neurobiology of language}
  ...
  \ALIUSPlacedTextContent{72.025}{597.764}{470.862}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-sperry-1962}Sperry, R. (1962). Some general aspects of interhemispheric integration In}
  ...
  \ALIUSPlacedTextContent{72.025}{648.764}{471.337}{ALIUSC000000}{\ALIUSFontCormorantRegular}{14.000}{\ALIUSRefAnchor{aliusref-skipper-roseman-koroma-fejer-tov-ng-2013}Tov, W., Ng, K. L., Lin, H., \& Qiu, L. (2013). Detecting well-being via computerized}
