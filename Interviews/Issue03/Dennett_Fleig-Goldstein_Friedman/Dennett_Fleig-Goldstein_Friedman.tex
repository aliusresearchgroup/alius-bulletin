...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \fill[white] (81.516bp,-256.747bp) rectangle ++(276.793bp,-40.600bp);
  \node[anchor=north west,inner sep=0pt,outer sep=0pt,text=ALIUSC000000] at (83.016bp,-258.747bp) {\begin{minipage}{273.793bp}{\ALIUSFontLatoLight\fontsize{9.200bp}{10.700bp}\selectfont\raggedright Cite as: Dennett, D., Fleig-Goldstein, B. \& Friedman, D. (2019). Dennett Explained. An interview with Daniel Dennett. ALIUS Bulletin \mbox{\textcolor{ALIUSC1F8135}{\href{https://doi.org/10.34700/7gkw-zh08}{https://doi.org/10.34700/7gkw-zh08}}}\par}\end{minipage}};
  ...
  \ALIUSPlacedTextContent{77.652}{533.994}{442.861}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{Your published worksâ€”and interviewsâ€”span volumes and fields, conveying complex}
  ...
  \ALIUSPlacedTextContent{116.555}{592.302}{403.845}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{(Hofstadter \& \ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-dennett-1982}{Dennett, 1982}) transcend genres as well as single authorship,}
  ...
  \ALIUSPlacedTextContent{371.942}{621.456}{148.564}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{(\ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-dennett-1996}{Dennett, 1996}) is as a clear}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{77.652}{723.846}{442.863}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{(\ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-hookway-2016}{Hookway, 2016}). You stated that Quine's view of a philosopher's primary role is to}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{77.652}{95.746}{442.861}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{do philosophy in this vein" (\ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-dennett-2003}{Dennett, 2003}). This in some ways contextualizes your place}
  ...
  \ALIUSPlacedTextContent{77.652}{478.188}{446.870}{ALIUSC000000}{\ALIUSFontCormorantMedium}{13.528}{saw that there was a rather Quinian way of handling themâ€”my "intentional stance."}
  ...
  \ALIUSPlacedTextContent{77.652}{681.164}{442.877}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{of the predictive processing paradigm (\ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-dennett-1993}{Dennett, 1993}). All of these actions comport}
  ...
  \ALIUSPlacedTextContent{77.652}{725.012}{442.819}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{theories, and providing speculative scientific theories themselvesâ€”even if it is a matter}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{77.652}{417.780}{443.680}{ALIUSC000000}{\ALIUSFontCormorantMedium}{13.528}{else. And sometimes 'hybrid vigor' is particularly valuable. SchrÃ¶dinger was no}
  ...
  \ALIUSPlacedTextContent{140.817}{595.134}{24.676}{ALIUSC7F7F7F}{\ALIUSFontCormorantLight}{46.647}{\ALIUSPullQuoteOpen}
  ...
  \ALIUSPlacedTextContent{158.829}{612.627}{247.134}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{how to do better science. Scientists are}
  \ALIUSPlacedTextContent{158.852}{630.119}{247.089}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{just as vulnerable to illusion, sloppy}
  ...
  \ALIUSPlacedTextContent{409.975}{665.105}{13.761}{ALIUSC7F7F7F}{\ALIUSFontCormorantLight}{46.647}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{235.083}{665.105}{94.627}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{as anyone else.}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{77.652}{124.901}{442.867}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{analysis is correct, then the "virtual governor" you discuss (e.g. in (\ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-dennett-2018}{Dennett, 2018})) may}
  ...
  \ALIUSPlacedTextContent{77.652}{411.250}{443.729}{ALIUSC000000}{\ALIUSFontCormorantMedium}{13.528}{are harderâ€”more painfulâ€”to think than others, and it has nothing to do with how}
  ...
  \ALIUSPlacedTextContent{77.652}{629.620}{442.846}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{way) Freud and Jung (\ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-brook-2003}{Brook, 2003}; \ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-jung-1963}{Jung, 1963}), as well as the predictive processing}
  \ALIUSPlacedTextContent{77.652}{644.313}{208.192}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{paradigm (\ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-clark-2013}{Clark, 2013}; \ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-swanson-2016}{Swanson, 2016}).}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{77.652}{492.944}{442.869}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{answered aboveâ€”what empirical evidence (if any) do you think it would take to sway}
  ...
  \ALIUSPlacedTextContent{77.652}{566.584}{443.698}{ALIUSC000000}{\ALIUSFontCormorantMedium}{13.528}{and Sweet Dreams (\ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-dennett-2006}{Dennett, 2006}), I was close to the cutting edge of the research}
  ...
  \ALIUSPlacedTextContent{77.652}{698.361}{443.675}{ALIUSC000000}{\ALIUSFontCormorantMedium}{13.528}{addition to the blossoming of new experimental paradigmsâ€”on beyond masked}
  ...
  \ALIUSPlacedTextContent{77.652}{731.480}{443.825}{ALIUSC000000}{\ALIUSFontCormorantMedium}{13.528}{othersâ€”there is mounting evidence, and hints of consensus, on the brain regions}
  \ALIUSPlacedTextContent{77.652}{783.303}{117.883}{ALIUSC767171}{\ALIUSFontLatoLight}{10.729}{ALIUS Bulletin nÂ°3 (2019)}
  \ALIUSPlacedTextContent{402.025}{783.303}{116.144}{ALIUSC767171}{\ALIUSFontLatoLight}{10.729}{aliusresearch.org/bulletin}
\end{tikzpicture}
\null
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{77.652}{81.223}{443.675}{ALIUSC000000}{\ALIUSFontCormorantMedium}{13.528}{involved. There is still some yawning chasmsâ€”nobody yet has a good account of}
  \ALIUSPlacedTextContent{77.652}{97.550}{443.675}{ALIUSC000000}{\ALIUSFontCormorantMedium}{13.528}{how content is registered and transmitted, so far as I knowâ€”but there's now an}
  ...
  \ALIUSPlacedTextContent{77.652}{186.008}{442.844}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{began during your discussions of the predictive processing paradigm (\ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-dennett-2013a}{Dennett, 2013a},}
  \ALIUSPlacedTextContent{77.652}{200.702}{442.877}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{2014). You seem to think ( \ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-dennett-2014}{Dennett, 2014}) that predictive coding provides a way to pay}
  ...
  \ALIUSPlacedTextContent{77.652}{229.856}{442.917}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{by Gibson in the context of ecological psychology (\ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-gibson-1979}{Gibson, 1979}). In particular, you}
  \ALIUSPlacedTextContent{77.652}{244.317}{442.843}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{suggest that brains produce "affordances galore" (\ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-dennett-2014}{Dennett, 2014}) by predicting the}
  ...
  \ALIUSPlacedTextContent{77.652}{302.625}{442.855}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{origins in the field of semiotics (\ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-salthe-2014}{Salthe, 2014}; \ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-uexkull-1910}{UexkÃ¼ll, 1910}). What led you to start}
  ...
  \ALIUSPlacedTextContent{77.652}{405.652}{443.703}{ALIUSC000000}{\ALIUSFontCormorantMedium}{13.528}{UexkÃ¼ll's idea of the Umwelt together draw attention to the economy or efficiency}
  ...
  \ALIUSPlacedTextContent{77.652}{438.538}{443.649}{ALIUSC000000}{\ALIUSFontCormorantMedium}{13.528}{effectively, swiftlyâ€”and with energetic efficiencyâ€”do what needs to be done. Don't}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{77.652}{95.746}{442.874}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{much more targeted, structured, interesting, complicatedâ€”take your pickâ€”way than in}
  ...
  \ALIUSPlacedTextContent{77.652}{267.873}{442.881}{ALIUSC1F8135}{\ALIUSFontLatoLightItalic}{12.128}{like dropping ink into a bowl of clear waterâ€”suddenly the convection currents operating in the}
  ...
  \ALIUSPlacedTextContent{77.652}{311.488}{442.867}{ALIUSC1F8135}{\ALIUSFontLatoLightItalic}{12.128}{is like a dye-marker being dropped into this aqueous system. And then you say, 'Oh, I seeâ€”it}
  ...
  \ALIUSPlacedTextContent{436.600}{438.609}{13.528}{ALIUSC000000}{\ALIUSFontSymbolFallback}{13.528}{Â¾}
  ...
  \ALIUSPlacedTextContent{194.736}{522.107}{13.528}{ALIUSC000000}{\ALIUSFontSymbolFallback}{13.528}{Â¾}
  ...
  \ALIUSPlacedTextContent{192.870}{572.718}{13.528}{ALIUSC000000}{\ALIUSFontSymbolFallback}{13.528}{Â¾}
  ...
  \ALIUSPlacedTextContent{140.817}{668.836}{24.676}{ALIUSC7F7F7F}{\ALIUSFontCormorantLight}{46.647}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{158.857}{668.836}{274.618}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{It's risky to subject your brain and body to}
  ...
  \ALIUSPlacedTextContent{158.817}{703.821}{274.697}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{challenge may prove very enlighteningâ€”and}
  \ALIUSPlacedTextContent{437.514}{721.314}{13.761}{ALIUSC7F7F7F}{\ALIUSFontCormorantLight}{46.647}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{229.476}{721.314}{133.380}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{possibly therapeutic.}
  \ALIUSPlacedTextContent{77.652}{783.303}{117.883}{ALIUSC767171}{\ALIUSFontLatoLight}{10.729}{ALIUS Bulletin nÂ°3 (2019)}
  \ALIUSPlacedTextContent{402.025}{783.303}{116.144}{ALIUSC767171}{\ALIUSFontLatoLight}{10.729}{aliusresearch.org/bulletin}
\end{tikzpicture}
\null
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{77.652}{130.669}{443.710}{ALIUSC000000}{\ALIUSFontCormorantMedium}{13.528}{for a philosopher to seriously confuse an interlocutor or readerâ€”to the point of}
  ...
  \ALIUSPlacedTextContent{140.817}{209.132}{24.676}{ALIUSC7F7F7F}{\ALIUSFontCormorantLight}{46.647}{\ALIUSPullQuoteOpen}
  \ALIUSPlacedTextContent{411.506}{209.132}{13.761}{ALIUSC7F7F7F}{\ALIUSFontCormorantLight}{46.647}{\ALIUSPullQuoteClose}
  ...
  \ALIUSPlacedTextContent{77.652}{607.633}{443.705}{ALIUSC000000}{\ALIUSFontCormorantMedium}{13.528}{I don't know how that can be enforced. Perhapsâ€”perhapsâ€”by passing legislation}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{158.883}{176.245}{281.596}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{I think that the policies that have been}
  \ALIUSPlacedTextContent{158.872}{193.738}{281.618}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{hammered out in academia for doing ethically}
  \ALIUSPlacedTextContent{158.884}{211.231}{281.594}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{defensible research, while not perfect, should}
  \ALIUSPlacedTextContent{158.900}{228.723}{281.563}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{be followed everywhereâ€¦ There will still be}
  ...
  \ALIUSPlacedTextContent{263.501}{263.708}{72.361}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{apparently,}
  \ALIUSPlacedTextContent{286.796}{263.708}{25.770}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{and}
  \ALIUSPlacedTextContent{284.448}{263.708}{30.466}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{they}
  \ALIUSPlacedTextContent{277.592}{263.708}{44.178}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{should}
  \ALIUSPlacedTextContent{287.781}{263.708}{23.801}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{not}
  \ALIUSPlacedTextContent{290.562}{263.708}{18.238}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{be}
  \ALIUSPlacedTextContent{158.878}{281.201}{281.607}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{romanticized or honored at all; they should be}
  \ALIUSPlacedTextContent{444.545}{298.693}{13.761}{ALIUSC7F7F7F}{\ALIUSFontCormorantLight}{46.647}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{198.353}{298.693}{202.656}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{regarded as intellectual vandals.}
  ...
  \ALIUSPlacedTextContent{77.652}{371.662}{442.864}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{(\ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-frazier-2009}{Frazier, 2009}). Pluralistic education may vaccinate children against traditional}
  ...
  \ALIUSPlacedTextContent{77.652}{485.185}{443.663}{ALIUSC000000}{\ALIUSFontCormorantMedium}{13.528}{"Show, don't tell"â€”as the teachers of fiction-writing urge. The project of rearing}
  ...
  \ALIUSPlacedTextContent{77.652}{678.070}{443.730}{ALIUSC000000}{\ALIUSFontCormorantMedium}{13.528}{children has been wiselyâ€”if largely unwittinglyâ€”exploited by the processes that}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{140.817}{192.572}{24.676}{ALIUSC7F7F7F}{\ALIUSFontCormorantLight}{46.647}{\ALIUSPullQuoteOpen}
  ...
  \ALIUSPlacedTextContent{158.883}{210.064}{288.462}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{all of us to love and protect our children has}
  \ALIUSPlacedTextContent{158.854}{227.557}{288.520}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{been wiselyâ€”if largely unwittinglyâ€”exploited}
  \ALIUSPlacedTextContent{158.864}{245.050}{288.499}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{by the processes that have generated our}
  ...
  \ALIUSPlacedTextContent{451.410}{280.035}{13.761}{ALIUSC7F7F7F}{\ALIUSFontCormorantLight}{46.647}{\ALIUSPullQuoteClose}
  \ALIUSPlacedTextContent{174.472}{280.035}{257.283}{ALIUSC595959}{\ALIUSFontLatoLight}{14.694}{In short we try not to "spoil" our children.}
  ...
  \ALIUSPlacedTextContent{77.652}{541.161}{443.637}{ALIUSC000000}{\ALIUSFontCormorantMedium}{13.528}{and inviting students to harmonize themâ€”by reordering them, reinterpreting them,}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{77.652}{220.993}{442.855}{ALIUSC1F8135}{\ALIUSFontLatoLight}{12.128}{any human ancestors (\ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-bond-tejedor-2015}{Bond et al., 2015}; \ALIUSCitationLink{aliusref-dennett-fleig-goldstein-friedman-perelman-johnson-2011}{Perelman et al., 2011}). How the New World}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{77.652}{109.140}{443.479}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-bogenschutz-podrebarac-2018}Bogenschutz, M. P., Podrebarac, S. K., Duane, J. H., Amegadzie, S. S., Malone, T. C., Owens,}
  \ALIUSPlacedTextContent{112.103}{124.301}{408.941}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{L. T., â€¦ Mennenga, S. E. (2018). Clinical Interpretations of Patient Experience in a}
  ...
  \ALIUSPlacedTextContent{77.652}{181.910}{443.472}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-bond-tejedor-2015}Bond, M., Tejedor, M. F., Campbell, K. E., Jr, Chornogubsky, L., Novo, N., \& Goin, F.}
  ...
  \ALIUSPlacedTextContent{112.103}{212.697}{185.119}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{monkeys. Nature, 520(7548), 538â€“541.}
  \ALIUSPlacedTextContent{77.652}{239.518}{447.449}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-brook-2003}Brook, A. (2003). Kant and Freud. In M. C. Chung \& C. Feltham (Eds.), Psychoanalytic}
  \ALIUSPlacedTextContent{110.874}{254.912}{286.087}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{Knowledge (pp. 20â€“39). London: Palgrave Macmillan UK.}
  \ALIUSPlacedTextContent{77.652}{281.734}{440.509}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-carhart-harris-friston-2010}Carhart-Harris, R. L., \& Friston, K. J. (2010). The default-mode, ego-functions and free-}
  ...
  \ALIUSPlacedTextContent{112.103}{312.521}{100.084}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{133(Pt 4), 1265â€“1283.}
  \ALIUSPlacedTextContent{77.652}{339.343}{443.402}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-carhart-harris-goodwin-2017}Carhart-Harris, R. L., \& Goodwin, G. M. (2017). The Therapeutic Potential of Psychedelic}
  \ALIUSPlacedTextContent{112.103}{354.736}{387.971}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{Drugs: Past, Present, and Future. Neuropsychopharmacology, 42(11), 2105â€“2113.}
  \ALIUSPlacedTextContent{77.652}{381.558}{443.463}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-clark-2013}Clark, A. (2013). Whatever next? Predictive brains, situated agents, and the future of}
  \ALIUSPlacedTextContent{112.103}{396.952}{337.275}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{cognitive science. The Behavioral and Brain Sciences, 36(3), 181â€“204.}
  \ALIUSPlacedTextContent{77.652}{423.774}{443.468}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-dennett-1982}Dennett, D.C. (1982). "Philosophy According to Nozick." New Boston Review 7}
  \ALIUSPlacedTextContent{112.103}{439.167}{147.750}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{(January/February 1982): 9-11.}
  \ALIUSPlacedTextContent{77.652}{466.222}{303.479}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-dennett-1993}Dennett, D. C. (1993). Consciousness Explained. Penguin UK.}
  \ALIUSPlacedTextContent{77.652}{493.044}{443.471}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-dennett-1996}Dennett, D. C. (1996). Darwin's Dangerous Idea: Evolution and the Meanings of Life. Simon}
  \ALIUSPlacedTextContent{112.103}{508.438}{69.133}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{and Schuster.}
  \ALIUSPlacedTextContent{77.652}{535.260}{443.469}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-dennett-2003}Dennett, D. C. (2003). Autobiography (Part 2). Retrieved January 4, 2019, from}
  ...
  \ALIUSPlacedTextContent{77.652}{577.708}{447.421}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-dennett-2006}Dennett, D. C. (2006). Sweet Dreams: Philosophical Obstacles to a Science of}
  ...
  \ALIUSPlacedTextContent{77.652}{619.924}{443.469}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-dennett-2013a}Dennett, D. C. (2013a). Expecting ourselves to expect: the Bayesian brain as a projector.}
  \ALIUSPlacedTextContent{110.874}{635.317}{250.689}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{The Behavioral and Brain Sciences, 36(3), 209â€“210.}
  \ALIUSPlacedTextContent{77.652}{662.139}{443.484}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-dennett-2013b}Dennett, D. C. (2013b). Intuition Pumps And Other Tools for Thinking. W. W. Norton \&}
  \ALIUSPlacedTextContent{112.103}{677.532}{53.670}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{Company.}
  \ALIUSPlacedTextContent{77.652}{704.354}{447.423}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-dennett-2014}Dennett, D. C. (2014). Why and How Does Consciousness Seem the Way it Seems? In Open}
  \ALIUSPlacedTextContent{110.874}{719.748}{238.018}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{MIND. Johannes Gutenberg UniversitÃ¤t Mainz.}
  \ALIUSPlacedTextContent{77.652}{783.303}{117.883}{ALIUSC767171}{\ALIUSFontLatoLight}{10.729}{ALIUS Bulletin nÂ°3 (2019)}
  \ALIUSPlacedTextContent{402.025}{783.303}{116.144}{ALIUSC767171}{\ALIUSFontLatoLight}{10.729}{aliusresearch.org/bulletin}
\end{tikzpicture}
\null
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{77.652}{81.152}{443.468}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-dennett-2017}Dennett, D. C. (2017). A History of Qualia. Topoi. An International Review of Philosophy.}
  ...
  \ALIUSPlacedTextContent{77.652}{123.368}{443.457}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-dennett-2017-2}Dennett, D. C. (2017). From Bacteria to Bach and Back: The Evolution of Minds. W.W.}
  \ALIUSPlacedTextContent{112.103}{138.761}{42.275}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{Norton.}
  \ALIUSPlacedTextContent{77.652}{165.583}{447.436}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-dennett-2018}Dennett, D. C. (2018). Facing up to the hard question of consciousness. Philosophical}
  ...
  \ALIUSPlacedTextContent{77.652}{223.192}{443.458}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-frazier-2009}Frazier, K. (2009). Dennett: Teach Children All the Facts about their Religion - CSI.}
  ...
  \ALIUSPlacedTextContent{77.652}{280.801}{443.371}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-garcia-romeu-richards-2018}Garcia-Romeu, A., \& Richards, W. A. (2018). Current perspectives on psychedelic therapy:}
  ...
  \ALIUSPlacedTextContent{110.874}{311.355}{88.338}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{Psychiatry , 1â€“26.}
  \ALIUSPlacedTextContent{77.652}{338.410}{447.443}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-gibson-1979}Gibson, J. J. (1979). "The theory of affordances", in The Ecological Approach to Visual}
  ...
  \ALIUSPlacedTextContent{77.652}{380.625}{447.447}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-hobson-friston-2016}Hobson, J. A., \& Friston, K. J. (2016). A Response to Our Theatre Critics. Journal of}
  \ALIUSPlacedTextContent{110.874}{396.019}{199.283}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{Consciousness Studies, 23(3-4), 245â€“254.}
  \ALIUSPlacedTextContent{77.652}{422.841}{447.416}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-hofstadter-dennett-1982}Hofstadter, D. R., \& Dennett, D. C. (1982). The Mind's I: Fantasies and Reflections on Self}
  \ALIUSPlacedTextContent{110.874}{438.234}{126.289}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{and Soul. Bantam Books.}
  \ALIUSPlacedTextContent{77.652}{465.056}{447.446}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-hookway-2016}Hookway, C. (2016). Pragmatism. In E. N. Zalta (Ed.), The Stanford Encyclopedia of}
  ...
  \ALIUSPlacedTextContent{77.652}{522.665}{443.477}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-jung-1963}Jung, C. G. (1963). Memories, Dreams, Reflections, tr. R. \& C. Winston; ed. Aniela JaffÃ©.}
  ...
  \ALIUSPlacedTextContent{77.652}{564.880}{447.461}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{Lorenzo. (2007). Podcast 117 â€“ 'The Importance of Psychedelics' - Psychedelic Salon}
  ...
  \ALIUSPlacedTextContent{77.652}{622.489}{443.424}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-perelman-johnson-2011}Perelman, P., Johnson, W. E., Roos, C., SeuÃ¡nez, H. N., Horvath, J. E., Moreira, M. A. M.,}
  \ALIUSPlacedTextContent{112.103}{637.649}{412.979}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{â€¦ Pecon-Slattery, J. (2011). A molecular phylogeny of living primates. PLoS}
  \ALIUSPlacedTextContent{110.874}{653.043}{120.818}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{Genetics, 7(3), e1001342.}
  \ALIUSPlacedTextContent{77.652}{680.098}{447.466}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-ross-brook-2000}Ross, D., Brook, A., \& Thompson, D. (2000). Dennett's Philosophy: A Comprehensive}
  \ALIUSPlacedTextContent{110.874}{695.492}{119.997}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{Assessment. MIT Press.}
  \ALIUSPlacedTextContent{77.652}{722.313}{440.501}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-salthe-2014}Salthe, S. N. (2014). Creating the Umwelt: From Chance to Choice. Biosemiotics, 7(3), 351â€“}
...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \ALIUSPlacedTextContent{77.652}{81.152}{447.403}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-swanson-2016}Swanson, L. R. (2016). The Predictive Processing Paradigm Has Roots in Kant. Frontiers}
  \ALIUSPlacedTextContent{110.874}{96.546}{161.359}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{in Systems Neuroscience, 10, 79.}
  \ALIUSPlacedTextContent{77.652}{123.368}{364.749}{ALIUSC1A1718}{\ALIUSFontCormorantMedium}{12.595}{\ALIUSRefAnchor{aliusref-dennett-fleig-goldstein-friedman-uexkull-1910}UexkÃ¼ll, J. von. (1910). Die Umwelt. Die Neue Rundschau, 21(2), 638â€“649. â–¡}
  \ALIUSPlacedTextContent{77.652}{783.303}{117.883}{ALIUSC767171}{\ALIUSFontLatoLight}{10.729}{ALIUS Bulletin nÂ°3 (2019)}
  \ALIUSPlacedTextContent{402.025}{783.303}{116.144}{ALIUSC767171}{\ALIUSFontLatoLight}{10.729}{aliusresearch.org/bulletin}
\end{tikzpicture}
\null
