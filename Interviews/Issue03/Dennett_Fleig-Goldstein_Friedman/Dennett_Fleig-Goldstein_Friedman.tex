...
\noindent\begin{tikzpicture}[remember picture,overlay,x=1bp,y=1bp,shift={(current page.north west)}]
  ...
  \node[anchor=south east,inner sep=0pt,outer sep=0pt,text=ALIUSC1F8135] at (356.809bp,-316.184bp) {{\ALIUSFontLatoLight\fontsize{8.600bp}{8.600bp}\selectfont\href{https://doi.org/10.34700/7gkw-zh08}{https://doi.org/10.34700/7gkw-zh08}}};
