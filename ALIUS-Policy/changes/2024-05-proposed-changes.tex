...
ALIUS includes two types of members: \emph{research members} and \sout{\emph{non-research members}.} \emph{active role members}.
...
\item The role of \sout{\emph{non-research members}.} \emph{active role members} is to help with outreach and communication (e.g., on \href{https://www.facebook.com/aliusresearch/}{social media}), with infrastructure (e.g., the \href{https://www.aliusresearch.org/}{website}) and with specific activities like the \href{https://www.aliusresearch.org/bulletin.html}{ALIUS Bulletin} or the ALIUS Podcast.
...
\item Promoting the group's activities and sharing relevant new publications of research members on the group's social media accounts. 
...
ALIUS is committed to improving gender diversity within the group. \sout{To this end, the group must count at least a \emph{third} (33\% rounded to the nearest integer) of women among its members at any time.}\textcolor{red}{To this end, an Inclusion Officer oversees the output and representation of disparate groups within ALIUS and presents an annual report, either in written or verbal form, with recommendations for enhancing diversity and inclusion across all of our output.}
...
\item Having actively participated to at least once to the ALIUS Bulletin as a contributor or co-editor

\item At the renewal date, sharing how they intent to contribute to the ALIUS Bulletin within the 3 years to come.

\item \textcolor{red}{Commit to an annual membership fee based on a tiered system reflecting your financial capacity, with an option to contribute a nominal amount if needed.}

\end{enumerate}

If a research member fails to satisfy these three conditions at the time of their assessment after three years, \textcolor{red}{and does not communicate a reason of extenuating circumstances to the coordinators}, their membership will \sout{not be renewed} \textcolor{red}{be deactivated.}

\textcolor{red}{If, at a later date, a deactivated member wishes to reactivate their membership, they may do so without reapplying for ALIUS membership.}
...
\item If research activities are interrupted (e.g., maternity leave), the period of 3 years will be extended by the necessary amount of time.
\end{itemize}
