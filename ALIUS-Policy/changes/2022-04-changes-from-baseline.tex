...
ALIUS includes \sout{three} \textcolor{red}{two} types of members: \emph{research members}\sout{, \emph{junior research members}} and \emph{non-research members}.
...
\item \sout{\emph{Junior research members} are graduate students whose work tackles (exclusively or non-exclusively) issues related to consciousness and the diversity of conscious states, but do not yet meet the other criteria for inclusion as research member outlined in \hyperref[new_memberships]{section 3.1} (in particular, having a PhD in a relevant discipline). Once they meet all the inclusion criteria, junior research members can ask to become research members. This will be subject to a vote, as for all new research memberships, but it is expected that junior research members will be favored over external candidates to become research members when they meet all the inclusion criteria. The number of junior research members is unlimited in principle.} 

\item The group can have a maximum of 3 \emph{non-research members} at any one time. The role of these members is to help with outreach and communication (e.g., on \href{https://www.facebook.com/aliusresearch/}{social media}), with infrastructure (e.g., the \href{https://www.aliusresearch.org/}{website}) and with specific activities like the \href{https://www.aliusresearch.org/bulletin.html}{ALIUS Bulletin} or the \sout{upcoming }ALIUS Podcast.
...
\item Proposing amendments to the present rules, and voting on such amendments once a year (see \hyperref[modif]{section 2}).
...
\item Promoting the group's activities and sharing relevant new publications of research members on the group's social media accounts. (Coordinators also have to update the list of publications on the website at least once every three years, but preferably more often.)
...
Any existing member can write to the coordinators to propose to invite a new \emph{research member}, \emph{junior research member} or \emph{non-research member} in the group. They must motivate this proposition by providing a short presentation of the candidate's work. The coordinators must ensure that the proposition fulfills the following inclusion criteria: \\

For new \emph{research members}:

\begin{enumerate}
\item They must be affiliated to an academic institution. 
\item \sout{They must hold a PhD or equivalent.}
\item Their research must inform or be informed by the empirical study of consciousness and conscious states. \sout{\This requires at least one publication in English in a peer-reviewed journal of international reputation (the satisfaction of this criterion is left to the appreciation of coordinators).}

\end{enumerate}

\sout{For new \emph{junior research members}:}

\begin{enumerate}
\sout{\item They must be affiliated to an academic institution.
\item They must be graduated students 
...
\noindent The invitation of new members will be submitted to a vote every six months, provided that any proposition has been put forward by existing members. Research members\sout{, junior research members} and non-research members can take part in this vote.
...
\item Having actively participated to at least \emph{two} of the following activities:

\begin{enumerate} 
\item Organizing a panel/workshop/conference that includes at least two ALIUS research members among the speakers
\item Speaking at a panel/workshop/conference organized by an ALIUS researcher and including two ALIUS research members among the speakers
\item Co-editing or contributing to the \href{https://www.aliusresearch.org/bulletin.html}{ALIUS Bulletin} 
\item Writing a post on one's research for the \href{https://www.aliusresearch.org/blog.html}{blog} on the ALIUS website (research members can write to the coordinators with a proposal for a short blog post at all times)
\item Contributing to the upcoming ALIUS Podcast (research members can write to the coordinators with a proposal for a podcast episode at all times)
\item Helping with the administration of the group (e.g. by being a coordinator)
\end{enumerate} 

\item One month before the renewal date, writing a short `note of intent' (750 to 1500 words) presenting one's current research and explaining how one's work and collaboration with other ALIUS members (if any) is contributing to the group's mission of advancing research on consciousness. These `notes of intent' will be gradually published on the blog throughout the following year as a way to present the work of each research member.
