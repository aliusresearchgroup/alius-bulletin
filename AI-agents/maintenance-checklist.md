...
- [ ] `AI-agents/layout_notable_quotes.py --check` passes after any notable-quote edit: quotes remain inside their Q&A segment, do not collide with fixed headers/footers, do not strand large blank bands before continued segment text, use compact one-line vertical gaps, and avoid hyphenated line breaks by using generated word-boundary line breaks.
